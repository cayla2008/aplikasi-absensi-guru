    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="relative flex flex-col min-w-0 break-words bg-white border-0 shadow-xl rounded-2xl bg-clip-border">
            <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid border-gray-200 rounded-t-2xl">
                <h6 class="text-lg font-bold text-slate-700">Tambah Ruang Kelas</h6>
            </div>
            ...
            <div class="flex-auto p-6">
                <form action="{{ route('ruang.store') }}" method="POST">
                    ...
                    {{-- Nama Ruang --}}
                    <div class="mb-4">
                        <label for="kelas_id" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700">
                            Pilih Ruang kelas
                        </label>
                        <select name="kelas_id" id="kelas_id" class="border rounded p-2 w-full">
