        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div
                    ...
                    <h6 class="text-lg font-bold">Table Tahun Pelajaran</h6>

                    <!-- 🔹 Tombol Tambah Tahun Pelajaran -->
                    <a href="{{ route('tahun_pelajaran.create') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div class="flex justify-center items-center space-x-4">
                                                ...
                                                {{-- Tombol Edit --}}
                                                <a href="{{ route('tahun_pelajaran.edit', $tahun_pelajaran->id) }}"
                                                ...
                                                {{-- Tombol Hapus --}}
                                                <form action="{{ route('tahun_pelajaran.destroy', $tahun_pelajaran->id) }}"
